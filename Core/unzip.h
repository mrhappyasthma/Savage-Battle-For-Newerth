...
int File_Unzip_Seek (struct file_s *file, long offset, int whence);
size_t File_Unzip_Write (const void *ptr, size_t size, size_t nmemb, struct file_s *stream);
int File_Unzip_Close (struct file_s *file);
int File_Unzip_Eof(struct file_s *file);
...
void    ZIP_SystemDir(void *archive, char *directory, char *wildcard, bool recurse,
